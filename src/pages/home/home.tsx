    ...
    <div id="Home" className="overflow-hidden">
      ...
      <div id="hero">
        <picture>
          <source
            ...
            srcSet="https://raw.githubusercontent.com/AndreiPirHu/Unico/main/src/assets/hero-image-small.webp"
          />
          <source
          ...
          />
          <img
            src="https://raw.githubusercontent.com/AndreiPirHu/Unico/main/src/assets/hero-image.png"
            alt=""
      ...
      <div className="flex max-h-[760px] mt-9 max-sm:max-h-[400px]">
        <div className=" flex-1 ">
          <img
            src="https://raw.githubusercontent.com/AndreiPirHu/Unico/main/src/assets/home-promo-image.png"
            alt=""
        ...
        <div className="flex-1 max-sm:hidden ">
          <img
            src="https://raw.githubusercontent.com/AndreiPirHu/Unico/main/src/assets/home-promo-image-2.png"
            alt=""
